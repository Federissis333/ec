...
module.exports = {
    name: "logs",
    description: "[💻 Administração] Configure o sistema de logs.",
    type: 1,
    options: [],
    permissions: {},
            ...
            collector.on('collect', async (i) => {
                ...
                if (i.user.id === interaction.user.id) {
                    if (i.customId === "ativar") {
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.status": true } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.status": false } })
                        ...
                        collector.on('collect', async (m) => {
                            ...
                            await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.entrada": canal.id } })
                        ...
                        collector.on('collect', async (m) => {
                            ...
                            await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.saida": canal.id } })
                        ...
                        collector.on('collect', async (m) => {
                            ...
                            await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.mensagem": canal.id } })
                        ...
                        collector.on('collect', async (m) => {
                            ...
                            await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.trafego": canal.id } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.entrada": "null" } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.saida": "null" } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.trafego": "null" } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "logs.mensagem": "null" } })
