...
module.exports = {
    name: "random",
    description: "[💻 Administração] Configure o sistema de random gif/icon/banner.",
    type: 1,
    options: [],
    permissions: {},
    run: async (client, interaction) => {
        ...
        interaction.reply({ embeds: [embed], components: [row, row2] }).then(async (m) => {
            ...
            collector.on('collect', async (i) => {
                ...
                if (i.user.id === interaction.user.id) {
                    if (i.customId === "estado-ativar") {
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "random.status": true, "random.status2": 2 } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "random.status": false, "random.status2": 1 } })
                        ...
                        collector.on('collect', async (m) => {
                            ...
                            await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "random.gif": canal.id } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "random.gif": "null" } })
                        i.deferUpdate();
                        ...
                        collector.on('collect', async (m) => {
                            ...
                            await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "random.icon": canal.id } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "random.icon": "null" } })
                        i.deferUpdate();
                        ...
                        collector.on('collect', async (m) => {
                            ...
                            await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "random.banner": canal.id } })
                        ...
                        await client.guilddb.updateOne({ IDs: interaction.guild.id }, { $set: { "random.banner": "null" } })
                        i.deferUpdate();
            ...
            collector.on('end', async (collected) => {
                ...
                interaction.editReply({ components: [new ActionRowBuilder().addComponents(estado).addComponents(gif).addComponents(icon).addComponents(banner), new ActionRowBuilder().addComponents(gif2).addComponents(icon2).addComponents(banner2)] })
            });
